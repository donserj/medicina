                        ...
                        <div class="box-body box-body-nopadding">
                            <form method="POST" class="form-horizontal" enctype="multipart/form-data">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="addtime" id="addtime" value="<?=$form['data'];?>" class="input-medium datepick">
                                        ...
                                        <div class="input-xlarge">
                                            <select name="select_categ" id="select_categ" class='chosen-select'>
                                                ...
                                                <?php foreach($data['categories'] as $category){ ?>
                                                    <option value="<?=$category['CategID'];?>"><?=$category['CategName_ro'];?></option>
                                                <?php } ?>
                                            </select></div>
                                    </div>
                                </div>
                                        ...
                                        <div class="input-xlarge">
                                            <select name="article_type" id="select_type" class='chosen-select'>
                                                ...
                                                <?php foreach($data['types'] as $type){ ?>
                                                    <option value="<?=$type['ArticleType'];?>"><?=$type['ArticleType'];?></option>
                                                <?php } ?>
                                            </select></div>
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <div class="uploader">
                                            <input type="file" name="article_img" class="uniform-me">
                                ...
                                <div class="form-actions">
                                    <input type="submit" name="newarticle" value="Save changes" class="button button-basic-blue">
                                    <a href="/admin/articles" class="button button-basic">Cancel</a>
                                </div>
                            </form>
                        </div>
                    </div>
