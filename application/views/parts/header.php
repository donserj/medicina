...
<head>
    ...
    <meta name="keywords" content="система платежи online интернет кошелек деньги обналичивание вывод webmoney paypal переводы терминал быстрой оплаты ecommerce платежный интегратор" />
    <meta name="description" content="Сервис online платежей в Молдове. Оплачивайте коммунальные услуги, мобильную связь, комьютерные игры в режиме онлайн. Пополнение WebMoney и их вывод на банковскую карточку" />
    ...
    <title> SfaturiMedicale </title>

    <link rel="icon" href="/bpa/image/favicon/bp1.ico" />
    <!---------------Bootsrap----------------------------->
    ...
    <!--link href="/assets/bootstrap/css/bootstrap.css.map" rel="stylesheet" type="text/css" media="screen" />
    ...
    <script language="JavaScript" type="text/javascript" src="/assets/js/revolution-slider.js"></script-->
        ...
        <div class="span16">
            ...
            <div id="dn-header">
                ...
                <div class="dn-banner760">
                    <a href="#"><img alt="banner 760" src="/assets/images/banner-top.jpg"></a>
                </div>

                <div class="dn-free-consult lang">
                    ...
                    <!--select id="demo-htmlselect">
                        ...
                        <option value="1" data-imagesrc="/assets/images/ru.png"
                                data-description=""> RU </option>
                    </select-->
                </div>
            </div>

            <?php $this->load->view("parts/menu_top"); ?>
